...
{
    public class ChangeUserPasswordMapperTester
    {
        private readonly IMapper _mapper;

        public ChangeUserPasswordMapperTester()
        {
        ...
        public void Should_not_have_error_ChangeUserPassword_to_User()
        {
            ...
            {
                Id = Guid.NewGuid(),
                OldPassword = "1234567SS123a56",
                NewPassword = "dhgfSAd123"
            };
            ...
            Assert.Equal("dhgfSAd123",  entity.Password);
